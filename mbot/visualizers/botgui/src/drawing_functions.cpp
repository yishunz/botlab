...
void draw_robot(const mbot_lcm_msgs::pose_xyt_t& pose, const float* color,  const float* body_color, vx_buffer_t* buffer)
{
...
void draw_laser_scan(const mbot_lcm_msgs::lidar_t& laser, const mbot_lcm_msgs::pose_xyt_t& pose, const float* color, vx_buffer_t* buffer)
{
...
void draw_path(const mbot_lcm_msgs::robot_path_t& path, const float* color, vx_buffer_t* buffer)
{
